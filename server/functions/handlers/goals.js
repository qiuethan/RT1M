...
export const addGoal = onCall(async (request) => {
  ...
  try {
    ...
    logger.info(`Added goal (legacy) for UID: ${uid}`);
    return result;
  } catch (error) {
    logger.error("Error adding goal (legacy):", error);
    throw new Error("Failed to add goal");
  }
});

/**
 * Update a goal (legacy)
 */
export const updateGoal = onCall(async (request) => {
  ...
  try {
    ...
    logger.info(`Updated goal (legacy) ${goalId} for UID: ${uid}`);
    return result;
  } catch (error) {
    logger.error("Error updating goal (legacy):", error);
    throw new Error("Failed to update goal");
  }
});

/**
 * Delete a goal (legacy)
 */
export const deleteGoal = onCall(async (request) => {
  ...
  try {
    ...
    logger.info(`Deleted goal (legacy) ${goalId} for UID: ${uid}`);
    return result;
  } catch (error) {
    logger.error("Error deleting goal (legacy):", error);
